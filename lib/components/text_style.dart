...
class AppTextStyles {
  ...
  static TextStyle titleMediumHeight = GoogleFonts.roboto(
      textStyle: TextStyle(
          fontSize: 14,
          color: AppColors.black,
          fontWeight: FontWeight.w400,
          height: 1.2));
  static TextStyle titleMediumLangHeight = GoogleFonts.roboto(
      textStyle: TextStyle(
          fontSize: 14,
          color: AppColors.black,
          fontWeight: FontWeight.w400,
  ...
  static TextStyle hintPurple = GoogleFonts.roboto(
      textStyle: TextStyle(
          ...
          fontWeight: FontWeight.w400));
  static TextStyle hintLitePurple = GoogleFonts.roboto(
      textStyle: TextStyle(
          fontSize: 12,
  ...
  static TextStyle gradeGreen = GoogleFonts.roboto(
      textStyle: TextStyle(
          fontSize: 11,
          fontWeight: FontWeight.w500,
  ...
  // --------------
  static TextStyle hintSmale = GoogleFonts.roboto(
      textStyle: TextStyle(
          fontSize: 10,
          color: AppColors.textLite,
          fontWeight: FontWeight.w400));
  ...
  static TextStyle hintSmaleLite = GoogleFonts.roboto(
      textStyle: TextStyle(
          ...
          fontWeight: FontWeight.w400));
  static TextStyle titleSmaleBold = GoogleFonts.roboto(
      textStyle: TextStyle(
